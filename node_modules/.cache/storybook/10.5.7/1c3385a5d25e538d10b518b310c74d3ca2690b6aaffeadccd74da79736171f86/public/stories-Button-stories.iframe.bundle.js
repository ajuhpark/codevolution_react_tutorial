"use strict";
(globalThis["webpackChunkcodevolution_react_tutorial"] ||= []).push([["stories-Button-stories"],{
...
/* harmony export */   Newstory: () => (/* binding */ Newstory),
...
;
const __namedExportsOrder = ["Primary", "Secondary", "Large", "Small", "Newstory"];
Primary.parameters = {
  ...Primary.parameters,
  docs: {
...
Newstory.parameters = {
  ...Newstory.parameters,
  docs: {
    ...Newstory.parameters?.docs,
    source: {
      originalSource: "{\n  args: {\n    primary: false,\n    label: \"Button\"\n  }\n}",
      ...Newstory.parameters?.docs?.source
    }
  }
};
