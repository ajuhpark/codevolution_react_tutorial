...
(() => {
  ...
  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-UBBB7RW7.js
  var __create, __defProp2, __getOwnPropDesc, __getOwnPropNames2, __getProtoOf, __hasOwnProp, __commonJS, __copyProps, __toESM, init_chunk_UBBB7RW7 = __esm({
    "node_modules/@storybook/addon-onboarding/dist/_browser-chunks/chunk-UBBB7RW7.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
  ...
  var theming_default, CacheProvider, ClassNames, Global, ThemeProvider, background, color, convert, create, createCache, createGlobal, createReset, css, darken, ensure, getPreferredColorScheme, ignoreSsrWarning, isPropValid, jsx, keyframes, lighten, srOnlyStyles, srOnlyUnsetStyles, styled, themes, tokens, typography, useTheme, withTheme, init_theming = __esm({
    "global-externals:storybook/theming"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
  ...
  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/Onboarding-ISBUXTH6.js
  var Onboarding_ISBUXTH6_exports = {};
  __export(Onboarding_ISBUXTH6_exports, {
    default: () => Onboarding
  });
...
`, NextButton = styled(Button)(({ theme: theme22 }) => ({
  ...
  // node_modules/@storybook/addon-onboarding/dist/_browser-chunks/Survey-ONUNS54C.js
  var Survey_ONUNS54C_exports = {};
  __export(Survey_ONUNS54C_exports, {
    default: () => Survey
  });
  function Survey({ api }) {
  ...
  var theme2, init_Survey_ONUNS54C = __esm({
    "node_modules/@storybook/addon-onboarding/dist/_browser-chunks/Survey-ONUNS54C.js"() {
      init_define_module();
      init_define_process_env();
      init_define_process_env_NODE_PATH();
  ...
  // node_modules/.cache/storybook/10.5.7/1c3385a5d25e538d10b518b310c74d3ca2690b6aaffeadccd74da79736171f86/sb-manager/onboarding-3/manager-bundle.js
  init_define_module();
  init_define_process_env();
  init_define_process_env_NODE_PATH();
  ...
  // node_modules/@storybook/addon-onboarding/dist/manager.js
  var Onboarding2 = lazy(() => Promise.resolve().then(() => (init_Onboarding_ISBUXTH6(), Onboarding_ISBUXTH6_exports))), Survey2 = lazy(() => Promise.resolve().then(() => (init_Survey_ONUNS54C(), Survey_ONUNS54C_exports))), root2 = null, render2 = (node) => {
